...
Trotz der hohen Genauigkeit erfordert die verbleibende Fehlerrate von 2,78\% weiterhin menschliche Qualitätskontrolle. Bei durchschnittlich 164 Objekten pro Plan entspricht dies etwa 4--5 Korrekturen. Das System ist daher als \textit{Human-in-the-Loop-Werkzeug} konzipiert, nicht als vollautomatische Lösung -- was für sicherheitskritische Anwendungen angemessen ist.
...
Der praktische Beitrag besteht in einem funktionsfähigen Prototyp mit Benutzeroberfläche für realistische Human-in-the-Loop-Workflows. Die integrierten Validierungswerkzeuge reduzieren den Prüfaufwand auf die 2,78\% fehlerhaften Fälle, was den Einsatz als Human-in-the-Loop-Werkzeug in sicherheitskritischen Anwendungen ermöglicht.

Damit leistet die Arbeit einen praxisnahen Beitrag zur digitalen Transformation innerhalb der Siemens Mobility GmbH und zeigt exemplarisch auf, wie moderne Verfahren der Computer Vision konkret auf industrielle Anwendungsfälle im Ingenieurwesen übertragen werden können. Der entwickelte Ansatz demonstriert, dass domänenspezifische Anpassungen generischer Deep-Learning-Architekturen in Kombination mit regelbasierter Nachverarbeitung eine effektive Strategie für die Automatisierung dokumentenbasierter Prozesse in technischen Domänen darstellen.
