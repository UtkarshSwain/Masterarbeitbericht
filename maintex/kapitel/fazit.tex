...
Mit nur 2 Linking-Fehlern bei 644 Objekten (0.31\% Fehlerrate) demonstriert dieser Ansatz, dass auch bei hoher Objektdichte -- die Testpläne enthielten durchschnittlich 92 Objekte pro Plan -- eine zuverlässige semantische Zuordnung möglich ist.
...
\begin{itemize}
    ...
    \item \textbf{Verbleibende Fehlerrate}: 1.24\% der Objekte erfordern manuelle Korrektur, was vollautomatischen Betrieb verhindert. Dies ist für sicherheitskritische Anwendungen jedoch akzeptabel -- der Prototyp ist als Assistenzsystem konzipiert.
