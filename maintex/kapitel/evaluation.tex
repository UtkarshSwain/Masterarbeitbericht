...
\hline
\multicolumn{2}{|l|}{\textit{Durchschnittliche Symbolanzahl pro Plan (12 Ankerklassen)}} \\
\hline
...
\hspace{3mm} Weichenenden & 3 \\
\hspace{3mm} Weichengruppenenden & 1 \\
\hspace{3mm} Prellböcke & 1 \\
\hspace{3mm} Haltetafeln & 1 \\
\hline
\hspace{3mm} \textbf{Summe (12 Ankerklassen)} & \textbf{164} \\
...
FP = False Positives (Extra-Erkennungen), die im Validierungsschritt entfernt werden können und daher nicht als Fehler gezählt werden.}
...
Der KI-gestützte Prozess reduziert den Gesamtzeitaufwand um \textbf{89,7\%}, von durchschnittlich 102 Minuten auf circa 10,6 Minuten pro Plan (\textbf{NFA-006}). Bei typischen Siemens Mobility Projekten mit 20-50 Gleisplänen ergibt sich eine Gesamtzeitersparnis von 30-76 Stunden (4-10 Arbeitstage) pro Projekt.
...
\begin{itemize}
    ...
    (Tabelle~\ref{tab:rotation_analysis})
    \item \textbf{FA-006} (Fahrtrichtung): 99.61\% Genauigkeit
...
\hline
FA-014 & Modulare Architektur: Alle 13~Symbolklassen erfolgreich integriert; modulare Architektur (Kapitel~\ref{chap:konzeption}) ermöglicht unabhängige Weiterentwicklung der Komponenten & Bestanden \\
\hline
...
\textit{Hinweis:} Die Änderungsanalyse wurde auf alle 12~Ankerklassen angewendet. Die Anzahl der unveränderten Objekte (112) bezieht sich auf die Objekte der im Vergleichsdialog ausgewählten Klassen.
...
FA-006 & Fahrtrichtungsdetektion & \checkmark (99.61\%) \\
...
NFA-006 & Prozessoptimierung & \checkmark (89,7\% Zeitersparnis) \\
NFA-007 & Ressourceneffizienz & \checkmark (10.6 min/Plan) \\
