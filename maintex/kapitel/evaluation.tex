...
\begin{enumerate}
    ...
    Bei einem Signal in Plan 6 konnte die Fahrtrichtung nicht durch geometrische Analyse abgeleitet werden, vermutlich aufgrund fehlender oder falsch detektierter Balise. Dies ist ein Linking-Fehler, da die geometrische Verknüpfung zwischen Signal und Balise nicht hergestellt werden konnte.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 1× Fahrtrichtung nicht abgeleitet (fehlende Balise-Detektion)
    \end{itemize}
