...
\hline
\multicolumn{3}{|c|}{\textit{Benutzerinteraktion und Konfiguration (FA-013 bis FA-014)}} \\
\hline
FA-013 & GUI-Workflow: PDF-Upload → Analyse-Start → Ergebnisanzeige → Export; Test durch 3 Anwender ohne CLI-Kenntnisse & Bestanden \\
\hline
FA-014 & Integration einer neuen Symbolklasse durch Nachtraining: 8 Auxiliarklassen erfolgreich hinzugefügt ohne Änderung der Kernlogik & Bestanden \\
\hline
