...
%   [6] Auxiliarklassen as deliberate scope limitation
...
Der finale Datensatz umfasst insgesamt \textbf{13~Symbolklassen}, die gemäß Anforderung \textbf{FA-003} in zwei Kategorien unterteilt werden:

\begin{itemize}
    \item \textbf{Kernklassen} (5~Klassen): \textit{signal}, \textit{coordinate}, \textit{gks\_festkodiert}, \textit{gks\_gesteuert} und \textit{gm\_block}. Diese repräsentieren die für die Projektierung bei Siemens Mobility essentiellen Fahrstraßen- und Stellwerkselemente und bilden den Fokus der End-to-End-Evaluation in Kapitel~\ref{chap:evaluation}.
    
    \item \textbf{Auxiliarklassen} (8~Klassen): \textit{sverbinder}, \textit{haltepunkt}, \textit{weichen\_block}, \textit{isolierstoß}, \textit{prellbock}, \textit{haltetafel}, \textit{endeweichen} und \textit{weichengruppeende}. Diese Klassen wurden gezielt in einem repräsentativen Subset der Bildausschnitte annotiert, um die Erweiterbarkeit des Systems zu demonstrieren (vgl.\ Anforderung \textbf{NFA-008}). Die Einschränkung auf ein Subset diente dazu, den Annotationsaufwand auf die projektierungsrelevanten Kernklassen zu fokussieren und den Gesamtumfang der Arbeit handhabbar zu halten.
\end{itemize}
...
\hline
\multicolumn{6}{|c|}{\textit{Kernklassen (produktionsrelevant)}} \\
\hline
...
\hline
\textbf{Summe Kern} & \textbf{---} & \textbf{9.793} & \textbf{---} & \textbf{2.436} & \textbf{12.229 (78,5\,\%)} \\
\hline
\multicolumn{6}{|c|}{\textit{Auxiliarklassen (Erweiterbarkeit)}} \\
\hline
...
\hline
\textbf{Summe Auxiliar} & \textbf{---} & \textbf{2.713} & \textbf{---} & \textbf{640} & \textbf{3.353 (21,5\,\%)} \\
\hline
\hline
...
Die \textbf{Instanzzahlen der Auxiliarklassen} erfordern eine differenzierte Betrachtung. Aus eisenbahntechnischer Sicht wäre zu erwarten, dass S-Verbinder und Isolierstöße in realen Gleisplänen mindestens ebenso häufig vorkommen wie Signale, da jedes Signal theoretisch einen S-Verbinder oder Isolierstoß in unmittelbarer Nähe besitzt, ergänzt durch weitere Vorkommen am Ende des Durchrutschweges, in Weichenbereichen und als Trennung mehrerer Gleisabschnitte \cite{Pachl}. Die im Datensatz beobachteten Instanzzahlen (S-Verbinder: 853, Isolierstoß: 765 vs.\ Signal: 2.348~gesamt) spiegeln diese theoretische Häufigkeit nicht vollständig wider. Diese Diskrepanz resultiert aus der \textit{bewussten Priorisierung der Annotationsarbeit} auf die fünf Kernklassen: Während Signale und Koordinaten in allen 24~Gleisplänen systematisch und vollständig annotiert wurden, erfolgte die Annotation der acht Auxiliarklassen in einem repräsentativen Subset der Bildausschnitte. Diese Einschränkung war notwendig, um den manuellen Annotationsaufwand auf die projektierungsrelevanten Kernklassen zu konzentrieren und den Gesamtumfang der Arbeit handhabbar zu halten. Die Auxiliarklassen dienen primär dem Nachweis der Erweiterbarkeit des Systems (Anforderung \textbf{NFA-008}) und nicht einer vollständigen Abdeckung aller Gleisplanelemente. Die detaillierte quantitative Evaluation der Erkennungsleistung über alle Klassen erfolgt in Kapitel~\ref{chap:evaluation}.
...
\hline
\multicolumn{4}{|c|}{\textit{Kernklassen}} \\
\hline
...
\hline
\textbf{$\varnothing$ Kernklassen} & \textbf{2.436} & \textbf{97,7\,\%} & \\
\hline
\multicolumn{4}{|c|}{\textit{Auxiliarklassen}} \\
\hline
...
\hline
\textbf{$\varnothing$ Auxiliarklassen} & \textbf{640} & \textbf{98,8\,\%} & \\
\hline
\hline
\textbf{$\varnothing$ Alle Klassen} & \textbf{3.076} & \textbf{98,4\,\%} & \\
\hline
\end{tabular}
\caption{Klassenspezifische AP@0.5 auf dem Validierungsdatensatz, sortiert nach Kategorie und absteigend nach AP@0.5}
...
prellbock & 1.0 & 2.0 & 80--130 px & 60--100 px & Auxiliar \\
weichenende & 1.0 & 3.0 & 80--130 px & 90--150 px & Auxiliar \\
weichengruppenende & 1.0 & 4.0 & 80--130 px & 120--200 px & Auxiliar \\
\hline
\end{tabular}
