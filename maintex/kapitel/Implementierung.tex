...
\begin{enumerate}
    ...
    \item \textbf{Orientierungsvielfalt}: Obwohl technische Zeichnungen Symbole in verschiedenen Winkeln enthalten, sind bestimmte Orientierungen (insbesondere $0°$ und $90°$) überrepräsentiert, während diagonale Ausrichtungen seltener auftreten.
\end{enumerate}
...
$$\Theta_{\text{aug}} = \{-90°, -60°, -45°, -30°, -15°, +15°, +30°, +45°, +60°, +90°\}$$
...
\hline
coordinate & 629 & 300 & 929 & 1.48× \\
signal & 218 & 382 & 600 & 2.75× \\
sverbinder & 85 & 515 & 600 & 7.06× \\
gks\_gesteuert & 69 & 531 & 600 & 8.70× \\
gm\_block & 91 & 509 & 600 & 6.59× \\
haltepunkt & 47 & 553 & 600 & 12.77× \\
gks\_festkodiert & 60 & 540 & 600 & 10.00× \\
weichen\_block & 39 & 561 & 600 & 15.38× \\
isolierstoß & 27 & 573 & 600 & 22.22× \\
prellblock & 16 & 584 & 600 & 37.50× \\
haltetafel & 11 & 589 & 600 & 54.55× \\
endeweichen & 4 & 596 & 600 & 150.00× \\
weichengruppeende & 9 & 591 & 600 & 66.67× \\
\hline
\textbf{Gesamt} & \textbf{1.305} & \textbf{6.724} & \textbf{8.029} & \textbf{6.15×} \\
\hline
\end{tabular}
\caption{Verteilung der Instanzen vor und nach synthetischer Rotation}
\label{tab:augmentation_statistics}
\end{table}
\textbf{Technische Umsetzung:}
Die hohen Augmentationsfaktoren für seltene Klassen (z.B. 150× für \textit{endeweichen}) sind gerechtfertigt, da diese Symbole in realen Gleisplänen tatsächlich sehr selten vorkommen, das Modell aber dennoch in der Lage sein muss, sie zuverlässig zu erkennen. Die synthetische Rotation simuliert realistische Orientierungsvariationen und verhindert Overfitting auf die wenigen Original-Samples. 
...
Eine negative lokale y-Koordinate bedeutet, dass die Balise sich oberhalb des Signals in dessen lokaler Orientierung befindet, was nach Konvention der Fahrtrichtung A entspricht. Eine positive lokale y-Koordinate indiziert, dass die Balise unterhalb des Signals liegt, was der Fahrtrichtung B zugeordnet wird. Abbildung~\ref{fig:signal_direction} veranschaulicht diese Bestimmung durch die relative Position der zugeordneten Balise im lokalen Koordinatensystem. Die Koordinatenangabe befindet sich zwischen Signal und Balise. Links ist der Fall $dy_{\text{local}} < 0$ (Balise oberhalb) dargestellt, was Fahrtrichtung~A entspricht; rechts der Fall $dy_{\text{local}} > 0$ (Balise unterhalb), entsprechend Fahrtrichtung~B.
\begin{figure}[H]
\centering
\begin{tikzpicture}[scale=1.3]
