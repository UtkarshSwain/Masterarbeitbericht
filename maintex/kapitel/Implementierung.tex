...
Die Fahrtrichtung wird durch die Vorzeichenbetrachtung der lokalen y-Koordinate der Balise relativ zum Signal bestimmt. Hierbei wird die in Abschnitt \ref{sec:Koordinatentransformation} beschriebene Koordinatentransformation angewendet, um die Position der Balise im lokalen Koordinatensystem des Signals zu ermitteln. Die Entscheidungsregel lautet:
...
Die Kombination dieser Techniken erreicht eine Linking-Genauigkeit von über 92\% auf den Testdaten (detaillierte Evaluierung in Kapitel \ref{chap:evaluation}), wobei die verbleibenden Fehler hauptsächlich auf ambige Fälle zurückzuführen sind, in denen mehrere Texte ähnliche Distanzen zum Symbol aufweisen.
