...
Das Training wurde auf einer cloud-basierten GPU-Instanz mit einer NVIDIA-GPU und 16~GB Videospeicher durchgeführt. Das Modell wurde mit auf dem COCO-Datensatz \cite{Lin2014_COCO} vortrainierten Gewichten initialisiert (\textit{Transfer Learning}), um die in den frühen Netzwerkschichten bereits gelernten generischen Merkmalsextraktoren -- wie Kanten-, Ecken- und Texturerkennung -- zu nutzen und die Konvergenz auf dem domänenspezifischen Gleisplan-Datensatz zu beschleunigen.
