...
achieving 97.22\% end-to-end accuracy for all 13 object classes,
integrating detection, OCR, and spatial linking in a unified evaluation metric.
The system reduces manual processing time by 89.7\%, from an average of 102 minutes
...
\vspace{1em}
\noindent\textbf{Keywords:} Deep Learning, Computer Vision, Object Detection, OBB, OCR, Human-in-the-Loop, Railway Infrastructure, Document Analysis, Automated Data Extraction, Change Detection
...
Die Lösung wird anhand von neun produktiven A0-Gleisplänen aus Siemens-Mobility-Projekten evaluiert und erreicht eine End-to-End-Genauigkeit von 97,22\% für alle 13 Objektklassen, wobei Erkennung, OCR und räumliches Linking in einer einheitlichen Evaluationsmetrik integriert werden. Das System reduziert die manuelle Bearbeitungszeit um 89,7\%, von durchschnittlich 102 Minuten auf etwa 10,6 Minuten pro Gleisplan. Eine umfassende PyQt5-basierte Desktop-Anwendung bietet interaktive Visualisierung, manuelle Korrekturwerkzeuge und Validierungs-Overlays für Human-in-the-Loop-Qualitätssicherung.
...
\vspace{1em}
\noindent\textbf{Schlagwörter:} Deep Learning, Computer Vision, Objekterkennung, OBB, OCR, Human-in-the-Loop, Eisenbahninfrastruktur, Dokumentenanalyse, Automatisierte Datenextraktion, Änderungserkennung
