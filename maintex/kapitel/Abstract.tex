...
railway projects and demonstrates 98.76\% end-to-end accuracy for core symbol classes
(signals, track circuits, coupling coils), integrating detection, OCR, and spatial linking
in a unified evaluation metric. The system reduces manual processing time by 75.3\%,
from an average of 64 minutes to approximately 16 minutes per A0 layout. A comprehensive PyQt5-based desktop application 
