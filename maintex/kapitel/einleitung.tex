...
\begin{itemize}
    ...
    \item \hyperref[chap:fazit]{\textbf{Kapitel 8 (Fazit)}} fasst die wichtigsten Erkenntnisse zusammen, reflektiert kritisch den Entwicklungsprozess und gibt einen Ausblick auf mögliche Weiterentwicklungen.
\end{itemize}