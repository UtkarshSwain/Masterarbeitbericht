...
\begin{itemize}
    \item \textbf{FA-001}\label{req:FA-001} \textbf{Erkennungsrate:} Der Prototyp \textbf{muss} mindestens 90\,\% der definierten Symbolklassen mit einer Mindest-Konfidenz von 0.5 \textbf{detektieren} (gemessen als Recall@0.5 des YOLO-Modells).
    ...
    \item \textbf{FA-003}\label{req:FA-003} \textbf{Detektionsziele:} Der Prototyp \textbf{muss} die in Tabellen~\ref{tab:kernklassen} (Kernklassen) und~\ref{tab:auxiliarklassen} (Auxiliarklassen) spezifizierten Symboltypen \textbf{detektieren}.
\end{itemize} 
...
\begin{itemize}
    \item \textbf{FA-004}\label{req:FA-004} \textbf{OCR-Genauigkeit:} Der Prototyp \textbf{muss} Textinformationen (Signalbezeichnungen, Kilometrierungen) mit einer Feldgenauigkeit von mindestens 95\,\% \textbf{extrahieren} (exakte Übereinstimmung des extrahierten Wertes mit Ground Truth).

    \item \textbf{FA-005}\label{req:FA-005} \textbf{Robustheit:} Wenn Textregionen unter erschwerten Bedingungen vorliegen (niedriger Kontrast, Bildrauschen, Rotation $0^\circ$--$360^\circ$, Überlagerungen), \textbf{muss} der Prototyp in der Lage sein, diese Texte mit mindestens 85\,\% Feldgenauigkeit zu \textbf{extrahieren}.
    \begin{figure}[H]
    \centering
