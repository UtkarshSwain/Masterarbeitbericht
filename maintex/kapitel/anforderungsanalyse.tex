...
§\ref{subsec:e2e_test_eval}: 637/644 Objekte vollständig korrekt extrahiert (98.91\% E2E, OCR-Anteil: 3 Fehler) \\
\hline

FA-005 & OCR-Robustheit (Rauschen, Rotation) & 
§\ref{sec:ocrpipeline}: Dual-Winkel-Routing, CLAHE, Linienentfernung & 
§\ref{subsec:e2e_test_eval}: 3 von 7 Gesamtfehlern OCR-bedingt; 
Fehlertypen: fehlende Extraktion (2×), Artefakt-Fehlinterpretation (1×) \\
\hline

FA-006 & Fahrtrichtungsdetektion & 
§\ref{sec:intelligentesymboltextverknüpfung}: Geometrische Ableitung aus GKS-Signal-Relation & 
§\ref{subsec:e2e_test_eval}: 171/172 Fahrtrichtungen korrekt (99.4\%), 
1 Fehler durch fehlende GKS-Signal Beziehung\\
\hline
...
§\ref{subsec:e2e_test_eval}: 2 Linking-Fehler bei 644 Objekten (99.7\%)\\
\hline
