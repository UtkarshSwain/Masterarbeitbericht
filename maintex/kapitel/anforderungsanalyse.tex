...
§\ref{subsec:detection_eval}: Stabile Leistung über alle Testpläne \\
\hline
...
§\ref{subsec:e2e_test_eval}: Erfolgreiche Extraktion bei $\theta = 37.5^\circ$ (Abb.~\ref{fig:angular_ocr_example}) \\
\hline
