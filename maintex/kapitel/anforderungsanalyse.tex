...
\begin{longtable}{|p{4cm}|p{8cm}|}
    \hline
    \textbf{Bezeichnung} & \centering\textbf{Symbol} \tabularnewline
    \hline
    \endhead

    % Row 1: Signale (Removed 1st, Kept 2nd)
    Signale & 
    ...
    % Row 2: Positionsangabe (Kept 1st, Removed 2nd)
    Positionsangabe & 
    \parbox[c]{8cm}{\centering
        \vspace{0.2cm}
    ...
    % Row 3: Gleiskoppelspulen (Kept 1st, Removed 2nd)
    Gleiskoppelspulen & 
    \parbox[c]{8cm}{\centering
        \vspace{0.2cm}
    ...
    % Row 4: Haltepunkt (Removed 1st, Kept 2nd)
    Haltepunkt & 
    \parbox[c]{8cm}{\centering
        \vspace{0.2cm}
    ...
    % Row 5: Weichen (Removed 1st, Kept 2nd)
    Weichen & 
    \parbox[c]{8cm}{\centering
        \vspace{0.2cm}
