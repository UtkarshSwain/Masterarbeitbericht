...
\usepackage[nohyperlinks]{acronym} % 'printonlyused' only lists acronyms you actually cite in the text
% OR use \usepackage{acronym} if you want to list ALL acronyms defined, even if not used.
...
% Verhindert vertikales Stretching von Absätzen auf nicht vollen Seiten
\raggedbottom
...
\usepackage{pdfpages}  % For including external PDF pages
...
\begin{titlepage}
    \begin{center}
       ...
       \includegraphics[width=0.2\textwidth]{images/IMW-logo.png}\\[2cm]
        ...
        % Title
        {\large \textbf{KI-gestützter Prototyp zur automatisierten Erkennung und Interpretation von Symbolen und Daten in PDF-basierten Gleisplänen}}\\[2cm]
...
\input{kapitel/anhang}  % Anhang mit Quellcode-Verweis
\clearpage
